//
//  CommentAudioTableViewCell.swift
//  BlindTune
//
...
class ProfilePostAudioTableViewCell: UITableViewCell, AVAudioPlayerDelegate {
    
    @IBOutlet var audioTitleLabel: UILabel!
    
    @IBOutlet  var sepreatorLabel: UILabel!
    
    @IBOutlet  var waveformView: SCSiriWaveformView!
    @IBOutlet  var usernameLabel: UILabel!
    @IBOutlet  var commentLabel: UILabel!
    @IBOutlet  var cellTypeIndicatorImage: UIImageView!
    ...
    @IBAction func cellButtonAction(_ sender: Any) {
        ...
        if button.isSelected {
            ...
            if audioPlayer == nil{
                ...
                self.cellTypeIndicatorImage.image = UIImage(named: "umute")
                audioPlayer.play()
            }
        }
