...
- (void)drawRect:(CGRect)rect
{
    ...
    NSArray *kDefaultColors = [NSArray arrayWithObjects: [UIColor brownColor], [UIColor blueColor], [UIColor blackColor],[UIColor redColor], [UIColor yellowColor], [UIColor cyanColor],[UIColor magentaColor],[UIColor greenColor],[UIColor systemPinkColor],[UIColor clearColor], nil];
	...
	for (int i = 0; i < 10; i++) {
		...
		CGContextSetLineWidth(context, strokeLineWidth + 1.0);
		...
		CGFloat progress = 1.0f - (CGFloat)i / 10.0;
		CGFloat normedAmplitude = (1.5f * progress - (2.0f / 10.0)) * self.amplitude;
		
		CGFloat multiplier = MIN(1.0, (progress / 3.0f * 2.0f) + (1.0f / 3.0f));
		[[[kDefaultColors objectAtIndex:i] colorWithAlphaComponent:multiplier * CGColorGetAlpha([[kDefaultColors objectAtIndex:i] CGColor])] set];
